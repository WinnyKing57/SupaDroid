...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
     ...
     */
    public SupabaseLibraryAccessors getSupabase() { return laccForSupabaseLibraryAccessors; }
    ...
    public static class SupabaseLibraryAccessors extends SubDependencyFactory {
        ...
        public SupabaseLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getAuth() { return create("supabase.auth"); }

            /**
             * Creates a dependency provider for postgrest (io.github.jan-tennert.supabase:postgrest-kt)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getPostgrest() { return create("supabase.postgrest"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: supabase (3.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
